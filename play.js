...
api.playedBeatChanged.on((beat) => {
    ...
    if(beat.lyrics[1] == "Đô") document.querySelector('.skills').setAttribute("src", `${arrImg[1]}`)
    if(beat.lyrics[1] == "Rê") document.querySelector('.skills').setAttribute("src", `${arrImg[2]}`)
